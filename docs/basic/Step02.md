# Step02 – Azure CycleCloud 배포 및 초기 설정
...
> 워크샵에서는 Password 방식 사용 권장 (빠른 실습 목적)
...
※ 실제 운영 환경에서는 Bastion 또는 Private 접근 권장
...
이제부터 Scheduler와 Compute Node가 등장합니다.
